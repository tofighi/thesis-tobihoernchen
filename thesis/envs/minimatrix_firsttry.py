...
class MiniMatrix(BaseAlpyneEnv):
    ...
    def _get_observation_space(self) -> spaces.Space:
        ...
        return spaces.Box(
            ...
            high=1,
            shape=(
                int(np.product(np.array(self.sim.get_observation().values()[0]).shape)),
            )
    ...
    def _convert_from_observation(
        ...
        return self._modify_observation(observation.values()[0])
